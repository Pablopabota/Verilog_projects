...
HD_PWD='C:/Users/Asus/OneDrive/Documentos/GitHub/Verilog_projects/Pynq/fsm_semaforo/fsm_semaforo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log semaforo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source semaforo.tcl -notrace
