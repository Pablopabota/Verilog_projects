...
HD_PWD='C:/Users/Asus/OneDrive/Documentos/GitHub/Verilog_projects/Pynq/fsm_semaforo/fsm_semaforo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log semaforo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source semaforo.tcl
